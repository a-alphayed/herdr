...
impl App {
    ...
    pub(crate) fn handle_api_request_after_internal_events_drained(
        ...
        let response = match request.method {
            ...
            Method::AgentListLocal(_) => return self.handle_agent_list_local(request.id),
            Method::AgentGet(target) => return self.handle_agent_get(request.id, target),
            Method::AgentFocus(target) => return self.handle_agent_focus(request.id, target),
            Method::AgentRename(params) => return self.handle_agent_rename(request.id, params),
            Method::AgentStart(params) => return self.handle_agent_start(request.id, params),
            Method::AgentTeardown(params) => return self.handle_agent_teardown(request.id, params),
            ...
            Method::AgentSubmit(params) => return self.handle_agent_submit(request.id, params),
