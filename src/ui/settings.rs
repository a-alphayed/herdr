...
mod tests {
    ...
    #[test]
    fn experiments_host_glass_uses_settings_checkmark_marker_when_enabled() {
        let mut app = AppState::test_new();
        ...
        assert!(rendered.contains("host glass [✓]"));
    }

    #[test]
    fn experiments_host_glass_keeps_empty_checkbox_marker_when_disabled() {
        let mut app = AppState::test_new();
