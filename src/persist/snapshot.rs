...
pub struct SessionSnapshot {
    ...
    #[serde(default)]
    pub host_rail_width: Option<u16>,
    #[serde(default)]
...
fn migrate_snapshot(raw: RawSessionSnapshot) -> Result<SessionSnapshot, String> {
    Ok(SessionSnapshot {
        ...
        host_rail_width: raw.host_rail_width,
...
pub fn capture(
    ...
    SessionSnapshot {
        ...
        host_rail_width: Some(host_rail_width),
...
mod tests {
    ...
    fn old_snapshot_defaults_sidebar_fields() {
        ...
        assert_eq!(restored.host_rail_width, None);
