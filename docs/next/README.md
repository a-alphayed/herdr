...
Linux and macOS direct installs use the stable update channel by default. Windows beta installs default to preview. To test preview builds from the `dev` integration branch before the next stable release:
